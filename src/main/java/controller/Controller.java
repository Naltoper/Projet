...
public class Controller {
  ...
  private ViewElement getViewElement(List<ModelElement> squareState) {
    ...
    // On itere sur chaque ModelElement (ModelElement.values())
    for (ModelElement potentialElement : ModelElement.values()) {
        // On vérifie si l'élément potentiel est présent dans la case courante
        if (squareState.contains(potentialElement)) {
            // Si l'élément est trouvé, on récupère son ViewElement associé
            return potentialElement.viewElement;
        }
    }
  ...
  public void initialize(int squareWidth, int squareHeight, int columnCount,
                                int rowCount, FirefighterBoard board) {
